;(function ($,window,document,undefined){
	...
	CP.BlockLysuModule = function (callback,title){
		this.$el = null;
		this.title = title;
		this.ID = 24;
	...
	CP.BlockLysuModule.prototype.init = function (sucessHandlde){
		var that = this;
	...
	CP.BlockLysuModule.prototype.callSerive = function (success){
		var that = this;
	...
	CP.BlockLysuModule.prototype.bindEvent = function (){
		var that = this;
