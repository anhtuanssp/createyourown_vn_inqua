...
;(function(window, document, fabric) {
  ...
  ButtonGroup.prototype.createButton = function(options, label) {
    var defaults = {
      image: 'help',
      type: 'default',
      group: 'default',
    ...
    var innerHTMLButton = '<i class="darkroom-icon-' + options.image + '"></i>';
    if(label !== undefined){
      innerHTMLButton += '<span>'+options.label+'</span>'
    }
  ...
  Darkroom.prototype = {
    ...
    defaults: {
      ...
      //tuanta
      //chuyen hinh vào main canvas callback
      covertToMainCanvasInqua : null
    },
    ...
    //tuanta
    //Convert to main canvas inqua
    covertToMainCanvasInqua : function(){
      this.options.covertToMainCanvasInqua.call(this);
    }
