  ...
  Darkroom.plugins['crop'] = Darkroom.Plugin.extend({
    ...
    cropCurrentZone: function() {
      ...
      image.onload = function() {
        ...
        if(canvas.getWidth() < imgInstance.width){
          var numberScale = canvas.getWidth()/imgInstance.width;
    
          if(numberScale >= 0.5)
            imgInstance.scale(numberScale-0.4);
          else
            imgInstance.scale(numberScale);
