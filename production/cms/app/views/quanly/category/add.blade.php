...
{{-- THỪA KẾ TỪ MAIN --}}
@section('title')
<title>ADMIN :: THEM MOI CHUYEN MUC</title>
@stop
...
@section('adminbody')
	<h3><i class="fa fa-edit fa-2x"></i> THÊM MỚI CHUYÊN MỤC</h3>
	{{-- FLASH MESSEAGE --}}
	...
	<hr>
	{{-- EDIT FORM --}}
	{{ Form::open(array('url'=>'quanly/chuyenmuc/storage', 'class'=>'form form-horizontal','enctype'=>"multipart/form-data")) }}
		{{--PANEL NOI DUNG--}}
