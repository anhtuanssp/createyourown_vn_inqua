...
@section('adminbody')
<h3>
	QUẢN LÝ ASSET MEDIAS
	<a href="{{ url('quanly/assetmedia/add') }}" class="btn btn-labeled btn-default"><span class="btn-label"><i class="glyphicon glyphicon-plus"></i></span>Add</a>
...
<div class="table table-responsive">
	...
	<tbody>
		...
		<td style="width:200px">
			<a href="{{ url('quanly/assetmedia/edit/'.$v->id) }}" title="" class="btn btn-default">Chỉnh sửa</a>
			<form id="delte_tintuc" style="display:inline-block" action="{{ url('quanly/assetmedia/delete') }}" method="post">
				{{Form::token()}}
...
{{ $asms->appends(Input::except('page'))->links(); }}

<a href="{{ url('quanly/tintuc/add') }}" class="btn btn-labeled btn-default"><span class="btn-label"><i class="glyphicon glyphicon-plus"></i></span>Thêm</a>
