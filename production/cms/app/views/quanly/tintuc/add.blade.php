...
@section('adminbody')
	<h3><i class="fa fa-edit fa-2x"></i> THÊM MỚI TIN TỨC</h3>
	{{-- FLASH MESSEAGE --}}
	...
	{{-- FLASH MESSEAGE --}}
		...
		<hr>
		{{-- EDIT FORM --}}
		{{ Form::open(array('url'=>'quanly/tintuc/storage', 'class'=>'form form-horizontal','enctype'=>"multipart/form-data")) }}
			...
			<div class="panel panel-default">
			  ...
			  <div class="panel-body">
				...
				{{--CATEGORY--}}
				<div class="form-group">
					<label for="" class="col-sm-2">Chuyên mục tin tức</label>
					<div class="col-sm-10">
