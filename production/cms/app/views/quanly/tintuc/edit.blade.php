...
{{-- THỪA KẾ TỪ MAIN --}}
@section('title')
<title>ADMIN :: CHỈNH SỬA TIN TỨC</title>
@stop
...
@section('adminbody')
	<h3><i class="fa fa-edit fa-2x"></i> EDIT TIN TUC</h3>
	{{-- FLASH MESSEAGE --}}
	...
	@if(!empty($tintuc))
		<hr>
		{{-- EDIT FORM --}}
		{{ Form::open(array('url'=>'quanly/tintuc/save', 'class'=>'form form-horizontal','enctype'=>"multipart/form-data")) }}
			{{--ID--}}
