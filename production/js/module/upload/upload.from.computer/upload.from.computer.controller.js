;(function ($,window,document,undefined){
	...
	CP.UploadFromComputerController.prototype.html = '<div data-step="3" data-intro="Chọn hình từ máy tính" class="panel panel-default" id="{0}">'+
														'<div class="panel-heading">Upload From Computer</div>'+
													'</div>';
