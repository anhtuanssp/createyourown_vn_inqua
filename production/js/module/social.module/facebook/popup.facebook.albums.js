...
;(function ($,window,document,undefined){
	...
	CP.PopupFacebookAblumsModule = function () {
		...
		this.$el = '';
		this.html = '<div class="albums-facebook popup-left-wrapper"><span class="next-albums" style="cursor:pointer"><i class="fa fa-chevron-circle-down fa-2x"></i></span><h4>Vui lòng chọn Album</h4></div>';
