...
<head>
	...
	<meta name="description" content="Sản phẩm - Thiết kế ly sứ, In ly sứ - Tự thiết kế ly sứ, In skin vỏ điện thoại Thiết kế áo thun online">
	<meta name="copyright" content="﻿﻿Inqua.vn" >
	<meta name="author" content="http://inqua.vn/" >
	<link rel="alternate" href="http://inqua.vn/" hreflang="vi-vn" />
	<title>CREATE YOUR OWN - THIẾT KẾ VỎ ĐIỆN THOẠI</title>
...
<body class="">
	...
	<div id="main-content" class="container_CP dmsp">
		<div class="sologan text-center">
			<h2>Chọn sản phẩm bạn muốn thiết kế</h2>
	...
	<div class="facebook-wall container_CP" style="margin-top:10px">
			...
			<div class="panel panel-default" style="min-height:300px">
				...
				<div class="panel-body">
					...
					<div class="fb-like-box" data-href="https://www.facebook.com/pages/inquavn/859642057445378" data-colorscheme="light" data-show-faces="true" data-header="true" data-show-border="true" ></div>
	...
	<div id="footer" class="container_CP">
		...
		<div class="copy-right">
			<a href="detroopers.com">Sản phẩm thuộc bản quyền của inqua.vn</a>
		</div>
		<div class="clearfix"></div>
		<ul class="info-dev">
	...
	<script src="js/service/facbookTracking.js"></script>
